                ...
                "fields": [
                    {
                        ...
                        "help": "Prevent repeated tool loops and risky bulk operations.",
                    },
                    {
                        "path": "execution_guard.max_repeat_tool_call",
                        "type": "number",
                        "label": "Max Repeated Tool Call",
                        "help": "Same tool + same args allowed this many times per task. 0 = no limit.",
                        "min": 0,
                        "max": 10,
                        "step": 1,
                    },
                    {
                        ...
                        "help": "Hard cap per task. 0 = no limit.",
                        "min": 0,
                        "max": 500,
                        "step": 1,
                    },
                    {
                        ...
                        "type": "number",
                        "label": "Max Shell Calls Per Task",
                        "help": "Hard cap for shell_execute per task. 0 = no limit.",
                        "min": 0,
                        "max": 100,
                        "step": 1,
                    },
                    {
                        ...
                        "type": "number",
                        "label": "Max Download Ops",
                        "help": "Hard cap for download-like shell operations per task. 0 = no limit.",
                        "min": 0,
                        "max": 100,
                        "step": 1,
                    },
                    {
                        ...
                        "type": "number",
                        "label": "Max Destructive Shell Ops",
                        "help": "Hard cap for delete/move/rename shell operations per task. 0 = no limit.",
                        "min": 0,
                        "max": 100,
                        "step": 1,
                    },
                    {
                        ...
                        "type": "boolean",
                        "label": "Confirm Bulk Shell Ops",
                        "help": "Require a second confirmation when a shell command looks bulk or risky.",
                    },
                    {
                        "path": "execution_guard.bulk_shell_score_threshold",
                        "type": "number",
                        "label": "Bulk Risk Threshold",
                        "help": "Higher value = fewer commands treated as bulk/risky.",
                        "min": 1,
                        "max": 10,
                        "step": 1,
                    },
                    {
                        ...
                        "type": "boolean",
                        "label": "Plan Check For High-Risk Tools",
                        "help": "Ask model for a safety plan before running HIGH/CRITICAL tools.",
                    },
                    {
                        ...
                        "model_mode": "plain",
                        "label": "Plan Model",
                        "help": "Model used for high-risk plan checking. Empty = current model.",
                    },
                    {
                        "path": "execution_guard.plan_max_tokens",
                        "type": "number",
                        "label": "Plan Max Tokens",
                        "help": "Token limit for high-risk plan generation.",
                        "min": 64,
                        "max": 1000,
                        "step": 16,
                    },
