    ...
    async def execute(self, params: dict[str, Any], context: ToolContext) -> ToolResult:
        ...
        try:
            ...
            guide = (
                ...
                f"The current screen is attached (as image or OCR text analysis).\n"
                f"To complete the task:\n"
                f"1. Analyze the screen content to understand what's visible\n"
                ...
                f"Tips:\n"
                f"- If you received OCR text analysis with coordinates, use the "
                f"center coordinates for mouse_action (e.g. click at center:(x,y))\n"
                f"- If you received an SVG, parse the x/y attributes for coordinates\n"
                f"- Use analyze_image tool for detailed coordinate extraction\n"
